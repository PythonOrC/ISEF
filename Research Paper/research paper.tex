...
\todo{label the diagram a little and add engineering drawing}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.33\linewidth}
		...
		\subcaption{OpenMV Module}
	\end{subfigure}%
	\begin{subfigure}[b]{0.33\linewidth}
		\centering		
		\includegraphics[width=\textwidth]{ESP8266}
		\subcaption{ESP8266 front and back}
	\end{subfigure}%
	\begin{subfigure}[b]{0.33\linewidth}
		\centering
...
\subsection{Single Segement Test}
...
\todo{add a little more to conclusion}
