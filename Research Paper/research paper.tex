...
As a soft-body robot, the structure of which can be divided into two parts. One is the firm structures, and one is the flexible structures. The flexible structures are the moving parts while the firm structures hold the flexible structures in place and connect them together. They will also house all the electrical components.
